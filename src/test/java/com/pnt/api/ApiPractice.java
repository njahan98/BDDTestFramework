...
*/
    ...
    public void getAllEmployees(){
        ...
        //status code returns from the backend. Documentation is in README.md. 200 means okay
        //remember status codes for interview
    ...
    public void getOneEmployee(){
        Response response = RestAssured.given().when().get(employeeEndpoint+1).then().
                assertThat().statusCode(200).extract().response();
        System.out.println(response.asString());

        //store into the JSONObject and print employee name
        JSONObject js = new JSONObject(response.asString());
